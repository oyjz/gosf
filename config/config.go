/*
package config implements methods for reading config files encoded in json using path expressions and default fallback values
thanks to https://github.com/creamdog/gonfig
*/
package config
